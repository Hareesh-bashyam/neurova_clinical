...
def generate_report_pdf(buffer, report_json):
    ...
    draw_text(
        25 * mm,
        y,
        "This report is generated by a software-based psychiatric assessment system and does not constitute "
        "a medical diagnosis, treatment recommendation, or prescription. Final clinical decisions must be "
