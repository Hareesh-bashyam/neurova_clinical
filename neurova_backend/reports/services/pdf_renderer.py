...
def render_legal_disclaimer(c, y):
    ...
    c.drawString(
        LEFT_MARGIN,
        y,
        "This report is generated by a software-based mental health screening system "
        "and does not constitute a clinical interpretation, treatment recommendation, or "
