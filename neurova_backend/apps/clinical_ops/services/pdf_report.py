...
def generate_report_pdf_bytes(report_context: dict) -> bytes:
    ...
    c.setFont("Helvetica-Bold", 10)
    c.drawString(left, y, "Report Validation & Clinical Responsibility")
    y -= 6 * mm
    ...
    c.drawString(left, 12*mm, report_context["header"].get("footer", "Generated by NeurovaX Clinical Engine. For screening support only. Requires clinician review."))
