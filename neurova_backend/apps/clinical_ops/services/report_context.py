...
def build_report_context(order: AssessmentOrder) -> dict:
    ...
    # 🔒 NORMALIZE FOR SIGNOFF COMPLIANCE
    ...
    ctx = {
        "header": {
            ...
            "footer": "Generated by NeurovaX Clinical Engine. Not a medical diagnosis. For clinician use."
        },
        "patient": {
        ...
        "disclaimers": [
            ...
            "Final diagnosis and treatment decisions must be made by a registered clinician.",
