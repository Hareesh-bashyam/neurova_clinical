...
def build_report_context(order: AssessmentOrder) -> dict:
    ...
    try:
        ...
        signed_at = localtime(rep.signed_at).strftime("%d %B %Y, %I:%M %p") if rep.signed_at else "-"
    ...
    ctx = {
        "header": {
            "org_name": "NeurovaX Clinical Engine",
        ...
        "order": {
            ...
            "status": order.status,  # ADDED for Watermarking
        },
        "summary": {
